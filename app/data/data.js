...
export const experience = [
    {
        ...
        items: [{ url: "https://www.linkedin.com/company/golabstech/", icon: LinkSvg, description: "Golabs LinkedIn"}]
    },
    {
        startDate: "2021",
        endDate: "2022",
        ...
        items: [{ url: "https://www.figma.com/@matthewvogas", icon: LinkSvg, description: "Figma 15k design downloads" }]
    },
    {
        startDate: "2021",
        endDate: "2022",
        ...
        items: [{ url: "https://medium.com/@mvttheo/levantar-inversi%C3%B3n-con-criptomonedas-futurista-o-una-estupidez-80dbfb5bc3a", icon: LinkSvg, description: "Blog" },]
    },
]
export const projects = [
    {
        image: Convida,
        name: "Convida",
        description: "QA and front-end testing for a personal care app",
    ...
    },
    {
        ...
        items: [{ url: "https://bungalowslasiguanas.com/", icon: LinkSvg, description: "La Fortuna" }]
    },
    {
        image: Harvest,
        name: "Harvest To Market",
        description: "Search Engine for a Farmers and Markets App",
        items: [{ url: "https://harvesttomarket.com/", icon: LinkSvg, description: "New Hampshire, USA" }]
    },
    {
        image: Hoosling,
        name: "Hoosling",
        description: "Cryptocurrency fundraising platform",
        items: [{ url: "https://medium.com/@matthewvogas/levantar-inversi%C3%B3n-con-criptomonedas-futurista-o-una-estupidez-80dbfb5bc3a?source=user_profile---------3----------------------------", icon: LinkSvg, description: "Blog" }]
    },
    {
        image: Mall,
        name: "World Plaza Mall, Ecuador",
        description: "Design of Mall Ecommerce in Ecuador",
        items: [{ url: "https://www.figma.com/community/file/1307779821278258232/eccommerce-web-apple-ux", icon: LinkSvg, description: "Figma Design" }]
    },
    {
        image: Norte,
        name: "Cabañas del Norte",
        description: "Design, development and maintenance of Website Hotel",
        items: [{ url: "https://cabanasdelnorte.com/", icon: LinkSvg, description: "La Fortuna" }]
    },
    {
        image: Studently,
        name: "Studently",
        description: "Web app Design for an education Startup",
        items: [{ url: "https://www.figma.com/design/KCnLCN7Ny5DkOER72d3b0e/Studently-App?node-id=0-1&t=xQd6q1CosCYD8aMG-1", icon: LinkSvg, description: "Figma Design" }]
    },
    {
        image: Transfer,
        name: "Transfer",
        description: "Design, development and maintenance of Transfer Website",
        items: [{ url: "https://google.com", icon: LinkSvg, description: "label" }]
    },
    {
        image: Venado,
        name: "Venado",
